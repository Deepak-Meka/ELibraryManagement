                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button ID="Button4" class="btn btn-info" runat="server" Text="GO" OnClick="Button4_Click" />
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ELibraryManagementConnectionString %>" SelectCommand="SELECT * FROM [book_master_tbl]"></asp:SqlDataSource>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    Description-
                                                            <asp:Label ID="Label12" runat="server" Text='<%# Eval("book_description") %>' Font-Bold="True" Font-Italic="True"></asp:Label>
